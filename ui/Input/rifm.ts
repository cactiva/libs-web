...
type Props = Args & {
    children: (arg0: RenderProps) => React.ReactNode;
};
...
export const useRifm = (props: Args): RenderProps => {
    ...
    if (
        ...
        React.useLayoutEffect(() => {
            ...
            let [
                ...
                isDeleleteButtonDown, // No operation means that value itself hasn't been changed, BTW cursor, selection etc can be changed
                isNoOperation,
            ] = valueRef.current;
            ...
            const charsToSkipAfterDelete =
                acceptedCharIndexAfterDelete !== -1
            ...
            const getCursorPosition = val => {
                ...
                for (let i = 0; i !== valueBeforeSelectionStart.length; ++i) {
                    let newPos =
                        val.indexOf(valueBeforeSelectionStart[i], start) + 1;
    ...
    React.useEffect(() => {
        // until https://developer.mozilla.org/en-US/docs/Web/API/FormEvent/inputType will be supported
